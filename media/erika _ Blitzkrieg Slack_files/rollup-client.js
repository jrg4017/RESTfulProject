...
},team_menu_h:$("#team_menu").height(),cached_wh:0,last_input_height:0,last_input_container_height:0,msgs_scroller_y:-1,footer_outer_h:-1,default_col_flex_top:-1,triggering_resize:false,resizeManually:function(c,d){c=c||"unspecified";
...
$("#channels_scroller").css("height",d-TS.view.team_menu_h-((TS.boot_data.feature_combined_menu?0:TS.view.footer_outer_h)+f));
...
$(c).removeClass("away active").addClass(f.presence).attr("title",f.presence);
...
}},maybeChangeConnectionDisplay:function(){if(TS.boot_data.feature_combined_menu){return
}var c;
var d=$("#connection_icon");
var e=$("#connection_status");
if(TS.view.current_connection_status=="online"){TSSSB.call("setConnectionStatus","online");
if(TS.model.user.presence=="away"){c=TS.model.data_urls.connection_icon_online_away;
e.text("away")
}else{c=TS.model.data_urls.connection_icon_online;
e.text("online")
}}else{if(TS.view.current_connection_status=="trouble"){TSSSB.call("setConnectionStatus","connecting");
c=TS.model.data_urls.connection_icon_trouble;
e.text("connecting...")
}else{TSSSB.call("setConnectionStatus","offline");
c=TS.model.data_urls.connection_icon_offline;
e.text("offline")
}}if(d.attr("src")!=c){d.attr("src",c).removeClass("hidden")
...
$(window).on("click",i);
if(!TS.qs_args.ignore_mm){$(window).on("mousemove",i)
...
if(TS.boot_data.feature_new_btns_in_channel_list&&i){$("#new_pg_btn").bind("click.open_dialog_or_menu",function(){TS.ui.group_create_dialog.start()
})
}TS.client.ui.checkUnseenChannelsImsGroupsWithUnreads()
...
if(u){q=TS.templates.builders.buildStar("im",u)+'<span class="name"><span class="prefix">@</span>'+u.name+TS.templates.makeMemberPresenceIcon(p)+'</span></span><i id="im_actions" class="ts_icon ts_icon_chevron_medium_down ts_icon_inherit"></i>'
...
q+='<span class="name '+o+'"><span class="prefix">'+m+"#</span>"+l.name+"</span><i id='channel_actions' class='ts_icon ts_icon_chevron_medium_down ts_icon_inherit'></i>"
}else{q=TS.templates.builders.buildStar("group",l);
q+='<span class="name '+o+'"><span class="prefix">'+m+TS.model.group_prefix+"</span>"+l.name+"</span><i id='group_actions' class='ts_icon ts_icon_chevron_medium_down ts_icon_inherit'></i>"
...
if(TS.model.active_channel_id){if(TS.boot_data.feature_screenhero){$("#active_channel_name .screenhero_call_icon").bind("click.video_call",function(v){TS.utility.screenhero.launchVideoCall(TS.model.active_channel_id)
})
}$("#active_channel_name .name, #channel_actions").bind("click.channel_actions",function(v){if(TS.tips.maybeDoThrobberProxyClick("channel_menu_tip_card_throbber",v)){return false
